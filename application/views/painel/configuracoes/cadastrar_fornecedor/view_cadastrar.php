...
<head>
    ...
    <title>Cadastrar Fornecedor - Configurações - SiGA</title>
...
<?php $this->load->view('common/view_menu_painel', array('posicao' => 9)); ?>
                        ...
                        <div class="col-md-4 col-md-offset-4">
                            <div class="alert alert-success alert-dismissible" role="alert">
                                ...
                                <div class="text-center">
                                    Fornecedor cadastrado com <b>sucesso!</b>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Cadastrar Fornecedor</p>
                </div>
                <div class="panel-body">
                    <form id="formCadastrarFornecedor" action="<?php echo base_url('/painel/configuracoes/cadastrarfornecedor/cadastrar') ?>" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="formFornecedor" class="control-label"><span style="color: #ac2925">*</span>Fornecedor:</label>
                                    <input id="formFornecedor" name="formFornecedor" type="text" placeholder="Insira o nome do fornecedor..."
                                           class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="formDescricao" name="formDescricao" class="form-control" type="text" placeholder="Insira uma descrição..."/>
                                </div>
                            </div>
                        </div>
                        <hr/>
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <a class="btn btn-success btn-block" id="botaoCadastrarFornecedor"><b>Cadastrar fornecedor</b></a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-center"><h4 class="modal-title" id="myModalLabel">Confirmação de Cadastro de Fornecedor</h4></div>
            </div>
...
<script src="<?php echo base_url('/js/painel/configuracoes/cadastrar-fornecedor.min.js') ?>"></script>
