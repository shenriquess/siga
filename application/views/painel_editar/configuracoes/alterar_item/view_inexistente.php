        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Item</p>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="alert alert-danger">
                                <h5><b>Atenção:</b> O item que você está buscando não existe.</h5>
                            </div>
                        </div>
                    </div>
                    <hr/>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php echo base_url('/paineleditar/configuracoes/alteraritem/lista'); ?>"><b>Voltar
                                        para a Lista de Itens</b></a>
                            </div>
                        </div>
                    </div>
                </div>
