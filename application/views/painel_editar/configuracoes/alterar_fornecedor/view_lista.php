        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Fornecedor - Fornecedores Cadastrados</p>
                </div>
                            ...
                            <div class="well">
                                ...
                                <div class="row thumbnail">
                                    <div class="col-md-12 div-scrollbar-2x">
                                        <br/>
                                        <?php
                                        if (isset($fornecedores) && $fornecedores) {
                                            foreach ($fornecedores as $fornecedor) {
                                                $url_editar = base_url('/paineleditar/configuracoes/alterarfornecedor/alterar/' . $fornecedor['id_fornecedor']);
                                                $url_excluir = base_url('/paineleditar/configuracoes/alterarfornecedor/confirmarexcluir/' . $fornecedor['id_fornecedor']);

                                                if ($fornecedor['descricao'] == "") {
                                                    $descricao = "(Sem Descrição)";
                                                } else {
                                                    $descricao = character_limiter($fornecedor['descricao'], 15);
                                                }

                                                echo '<div class="row">';
                                                echo '<div class="col-md-5">';
                                                echo '<h5>' . $fornecedor['nome'] . '</h5>';
                                                echo '</div>';
                                            ...
                                            echo '<div class="text-center"><h5>No momento não há cadastro de fornecedores.</h5></div>';
                                        }
                                        ?>
                                    </div>
                                </div>
