                        ...
                        <div class="col-md-4 col-md-offset-4">
                            <div class="alert alert-success alert-dismissible" role="alert">
                                ...
                                <div class="text-center">
                                    Fornecedor alterado com <b>sucesso!</b>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Fornecedor - Alterar Dados</p>
                </div>
                <div class="panel-body">
                    <form id="formAlterarFornecedor"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="formFornecedor" name="formFornecedor" type="text"
                                           class="form-control"
                                           placeholder="Insira o nome do fornecedor..."
                                        <?php
                                            if (isset($fornecedor['nome']) && $fornecedor['nome']) {
                                                echo 'value="' . $fornecedor['nome'] . '"';
                                            }
                                        ?>
                                        />
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="formDescricao" name="formDescricao" type="text" class="form-control"
                                        ...
                                        <?php
                                            if (isset($fornecedor['descricao']) && $fornecedor['descricao']) {
                                                echo 'value="' . $fornecedor['descricao'] . '"';
                                            }
                                        ?>
                                        />
                                </div>
...
<script src="<?php echo base_url('/js/painel_editar/configuracoes/alterar_fornecedor/alterar.min.js') ?>"></script>
