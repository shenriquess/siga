        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Destino - Destinos Cadastrados</p>
                </div>
                                    ...
                                    <div class="col-md-12 div-scrollbar-2x">
                                        ...
                                        if (isset($destinos) && $destinos) {
                                            foreach ($destinos as $destino) {
                                                $url_editar = base_url('/paineleditar/configuracoes/alterardestino/alterar/' . $destino['id_destino']);
                                                $url_excluir = base_url('/paineleditar/configuracoes/alterardestino/confirmarexcluir/' . $destino['id_destino']);

                                                if ($destino['descricao'] == "") {
                                                    $descricao = "(Sem Descrição)";
                                                } else {
                                                    $descricao = character_limiter($destino['descricao'], 15);
                                                }

                                                echo '<div class="row">';
                                                echo '<div class="col-md-5">';
                                                echo '<h5>' . $destino['nome'] . '</h5>';
                                                echo '</div>';
                                            ...
                                            echo '<div class="text-center"><h5>No momento não há cadastro de destinos.</h5></div>';
                                        }
                                        ?>
                                    </div>
                                </div>
