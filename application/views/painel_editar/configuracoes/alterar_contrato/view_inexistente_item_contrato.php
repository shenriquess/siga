                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="alert alert-danger">
                                <h5><b>Atenção:</b> O item do contrato que você está buscando não existe.</h5>
                            </div>
                        </div>
                    </div>
                    <hr/>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php echo base_url('/paineleditar/configuracoes/alterarcontrato/lista'); ?>"><b>Voltar
                                        para a Lista de Contratos</b></a>
                            </div>
                        </div>
                    </div>
                </div>
