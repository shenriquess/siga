        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Item do Contrato</p>
                </div>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="alert alert-success">
                                        <div class="text-center">
                                            <h5>Item do Contrato removido com <b>sucesso!</b></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>';
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="alert alert-danger">
                                        <div class="text-center">
                                            <h5>
                                            <b>Erro</b> ao remover o item do contrato.<br/>
                                            ' . $erro_mensagem . '
                                            </h5>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php
                                   if (isset($item_contrato['id_contrato']) && $item_contrato['id_contrato']) {
                                       echo base_url('/paineleditar/configuracoes/alterarcontrato/alterar/contrato/' . $item_contrato['id_contrato']);
                                   } else {
