            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h5><b><?php echo $contrato['nome_fornecedor']; ?></b></h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <h5><b><?php echo $contrato['codigo']; ?></b></h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <h5>
                                <b><?php echo $contrato['data_inicio'] . ' até ' . $contrato['data_fim']; ?></b>
                            </h5>
                        </div>
                    </div>
                    <hr/>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <h5><b>Tem certeza que deseja excluir o contrato acima?</b></h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php echo base_url('/paineleditar/configuracoes/alterarcontrato/lista'); ?>"><b>Não</b></a>
                                <a href="<?php echo base_url('/paineleditar/configuracoes/alterarcontrato/excluir/contrato/' . $contrato['id_contrato']); ?>"
