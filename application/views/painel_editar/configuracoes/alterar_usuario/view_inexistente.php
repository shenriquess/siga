        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Usuário</p>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="alert alert-danger">
                                <h5><b>Atenção:</b> O usuário que você está buscando não existe.</h5>
                            </div>
                        </div>
                    </div>
                    <hr/>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php echo base_url('/paineleditar/configuracoes/alterarusuario/lista'); ?>"><b>Voltar
                                        para a Lista de Usuários</b></a>
                            </div>
                        </div>
                    </div>
                </div>
