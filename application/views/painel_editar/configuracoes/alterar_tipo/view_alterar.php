        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <p class="header-painel">Alterar Tipo - Alterar Dados</p>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="formTipo" class="control-label"><span
                                            style="color: #ac2925">*</span>Tipo:</label>
                                    <input id="formTipo" name="formTipo" type="text"
                                           class="form-control"
                                           placeholder="Insira o nome do tipo..."
                                        <?php
                                            if (isset($tipo['nome']) && $tipo['nome']) {
                                                echo 'value="' . $tipo['nome'] . '"';
                                            }
                                        ?>
                                        />
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="formDescricao" name="formDescricao" type="text" class="form-control"
                                        ...
                                        <?php
                                            if (isset($tipo['descricao']) && $tipo['descricao']) {
                                                echo 'value="' . $tipo['descricao'] . '"';
                                            }
                                        ?>
                                        />
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a class="btn btn-default"
                                   href="<?php echo base_url('/paineleditar/configuracoes/alterartipo/lista'); ?>"><b>Voltar</b></a>
...
<script src="<?php echo base_url('/js/painel_editar/configuracoes/alterar_tipo/alterar.min.js') ?>"></script>
